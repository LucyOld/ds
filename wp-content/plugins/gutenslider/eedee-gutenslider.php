...
/**
 * Plugin Name: Gutenslider — The last slider block you will ever need.
 * Plugin URI: https://gutenslider.org
 * Description: Simple, intuitive, powerfull image and video slider block for Gutenberg that creates appealing slides to enrich your content. Gutenslider delivers.
 * Author: eedee
...
if ( !class_exists( 'Gutenslider' ) ) {
    ...
    final class Gutenslider
    {
        ...
        private function includes()
        {
            ...
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-register-blocks.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-generated-styles.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-body-classes.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-form.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-font-loader.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-post-meta.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-google-map-block.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-accordion-ie-support.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/class-gutenslider-block-settings.php';
            // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/get-dynamic-blocks.php';
            
            if ( is_admin() || defined( 'WP_CLI' ) && WP_CLI ) {
                require_once GUTENSLIDER_PLUGIN_DIR . 'includes/admin/class-gutenslider-admin-start-page.php';
                // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/admin/class-gutenslider-action-links.php';
                // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/admin/class-gutenslider-feedback.php';
                // require_once GUTENSLIDER_PLUGIN_DIR . 'includes/admin/class-gutenslider-install.php';
            }
        ...
        {
            // if ( 'js' === $type ) {
            // 	return SCRIPT_DEBUG ? GUTENSLIDER_PLUGIN_URL . 'src/' . $type . '/' . $directory : GUTENSLIDER_PLUGIN_URL . 'dist/' . $type . '/' . $directory;
            // } else {
            // return GUTENSLIDER_PLUGIN_URL . 'dist/css/' . $directory;
            // }
