		...
		<div class="container">
			<div class="row gs-admin-intro flex">
				<div class="col-12 col-md-9 d-flex align-items-center">
					<h1>Getting Started with <b>Gutenslider</b></h1>
				</div>
			...
			<div class="row">
				<div class="col-md-6 d-flex align-items-center py-5">
					<div class="d-flex flex-column">
						<h2>Welcome to Gutenslider 2.8.7</h2>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 pt-5">
					<h2>Learn how to use Gutenslider</h2>
				</div>
				<div class="col-md-6 py-5">
					<div class="blog-post">
						<a href="https://gutenslider.org/gutenslider-tutorial-how-to-add-sliders-to-your-wordpress-website/"><h3 class="post-heading">Creating your first Gutenslider</h3></a>
...
?>" /></a>
				...
				<div class="col-md-6 py-5">
					<div class="blog-post">
						<a href="https://gutenslider.org/wordpress-fullscreen-background-slider/"><h3 class="post-heading">Fullscreen Sliders in Wordpress</h3></a>
...
if ( gutenslider_fs()->is_not_paying() ) {
	...
	<section class="pricing py-5">
		<div class="container">
			<h2>Compare our Plans<small>and get creative with Gutenslider Pro / Expert</small></h2>
				...
				<div class="col-lg-4 col-12">
					<div class="card mb-5 mb-lg-0">
						<div class="card-body plan-free">
							...
							<a href="#" class="btn btn-block text-uppercase">Your Version</a>
						</div>
					</div>
				</div>
				<!-- Plus Tier -->
